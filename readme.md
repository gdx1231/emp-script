...
```sql
CREATE TABLE EWA_CFG (
	XMLNAME varchar(200) COLLATE Chinese_PRC_CI_AS NOT NULL,
	ITEMNAME varchar(100) COLLATE Chinese_PRC_CI_AS NOT NULL,
	XMLDATA ntext COLLATE Chinese_PRC_CI_AS NOT NULL,
	HASH_CODE int NOT NULL,
	ADM_LID varchar(50) COLLATE Chinese_PRC_CI_AS NULL,
	CREATE_DATE datetime NULL,
	UPDATE_DATE datetime NULL,
	MD5 varchar(32) COLLATE Chinese_PRC_CI_AS NULL,
	DATASOURCE varchar(123) COLLATE Chinese_PRC_CI_AS NULL,
	CLASS_ACL varchar(333) COLLATE Chinese_PRC_CI_AS NULL,
	CLASS_LOG varchar(333) COLLATE Chinese_PRC_CI_AS NULL,
...
CREATE TABLE EWA_CFG_OTH (
	OTH_TAG varchar(50) COLLATE Chinese_PRC_CI_AS NOT NULL,
	OTH_TXT ntext COLLATE Chinese_PRC_CI_AS NULL,
...
CREATE TABLE EWA_CFG_TREE (
	XMLNAME varchar(200) COLLATE Chinese_PRC_CI_AS NOT NULL,
	EDIT_STATUS varchar(10) COLLATE Chinese_PRC_CI_AS NULL,
