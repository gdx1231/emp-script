 ...
 *
 */
public class Bar extends Column {
	 ...
	 * @param session
	 */
	public Bar(HttpServletRequest request, HttpSession session) {
	 ...
	 * @param imageHeight
	 */
	public Bar(String labelData, String seriesData, String chartData,
