 ...
 *
 */
public class Bar3D extends Column {
	 ...
	 * @param session
	 */
	public Bar3D(HttpServletRequest request, HttpSession session) {
	 ...
	 * @param imageHeight
	 */
	public Bar3D(String labelData, String seriesData, String chartData,
	...
	private void createChart(String name) {
		JFreeChart jfc = ChartFactory.createBarChart3D("", "", "",
				super._DefaultCategoryDataset, PlotOrientation.HORIZONTAL, true,
				true, true);
