 ...
 *
 */
public class BarStacked3D extends Column {
	 ...
	 * @param session
	 */
	public BarStacked3D(HttpServletRequest request, HttpSession session) {
	 ...
	 * @param imageHeight
	 */
	public BarStacked3D(String labelData, String seriesData, String chartData,
	...
	private void createChart(String name) {
		JFreeChart jfc = ChartFactory.createStackedBarChart3D ("", "", "",
				super._DefaultCategoryDataset, PlotOrientation.HORIZONTAL,
				true, true, true);
