...
public interface ICategory {
	...
	public abstract void setData(DefaultCategoryDataset catagoryDataset);
	...
	/**
	 * @param labelDataName the _LabelDataName to set
	 */
	...
	/**
	 * @param chartDataName the _ChartDataName to set
	 */
	...
	/**
	 * @param seriesDataName the _SeriesDataName to set
	 */
	public abstract void setSeriesDataName(String seriesDataName) ;
	
	public abstract void setChartName(String chartName);
	
	public abstract DefaultCategoryDataset getDefaultCategoryDataset();
	
	
	public int getImageWidth();

	/**
	 * @param imageWidth the _ImageWidth to set
	 */
	...
	/**
	 * @param imageHeight the _ImageHeight to set
	 */
	...
	/**
	 * @param chartType the _ChartType to set
	 */
