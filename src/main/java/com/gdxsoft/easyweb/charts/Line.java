...
public class Line extends Column {
	public Line() {
	 ...
	 * @param session
	 */
	public Line(HttpServletRequest request, HttpSession session) {
	 ...
	 * @param imageHeight
	 */
	public Line(String labelData, String seriesData, String chartData,
	...
	private void createChart(String name) {
		JFreeChart jfc = ChartFactory.createLineChart("", "", "",
				super._DefaultCategoryDataset, PlotOrientation.VERTICAL,
				true, true, true);
