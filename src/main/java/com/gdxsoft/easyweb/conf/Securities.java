...
public class Securities {
	private static Logger LOGGER = LoggerFactory.getLogger(Securities.class);
	private static Securities INST = null;
...
//				key="xxxx" iv="xxx" base64Encoded="true"/>
	...
	private List<Security> lst;

	public Securities() {
		this.lst = new ArrayList<>();
	}

	public Security getDefaultSecurity() {
		return defaultSecurity;
	}

	public void setDefaultSecurity(Security defaultSecurity) {
		this.defaultSecurity = defaultSecurity;
	}

	public List<Security> getLst() {
		return lst;
	}

	public void setLst(List<Security> lst) {
		this.lst = lst;
	}
