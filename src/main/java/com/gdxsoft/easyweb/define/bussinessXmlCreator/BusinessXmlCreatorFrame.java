 ...
 * Frame 业务 XML 创建器
 */
public class BusinessXmlCreatorFrame extends BusinessXmlCreatorBase {

    public BusinessXmlCreatorFrame(EwaConfig config, Table table) {
        super(config, table);
    }
    ...
    private Element createXItem(Document doc, Field field,
        ...
        tagSet.setAttribute("Tag", getTagType(field.getDatabaseType(), field.getName(), "Frame"));
    ...
    private void createDefaultPageAction(Document doc, Element action,
        ...
        if (operationType.equals("M") || operationType.equals("N") || operationType.equals("NM")) {
            Element onPostAction = doc.createElement("Set");
            onPostAction.setAttribute("Type", "OnPagePost");
            Element onPostCall = doc.createElement("CallSet");
            Element onPostCallSet = doc.createElement("Set");
