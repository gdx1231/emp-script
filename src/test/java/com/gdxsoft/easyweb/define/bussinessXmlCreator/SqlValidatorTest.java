...
public class SqlValidatorTest {
    ...
    public void testCheckIsSelect() {
        assertTrue(SqlValidator.checkIsSelect("SELECT * FROM table"));
        assertTrue(SqlValidator.checkIsSelect("  SELECT * FROM table"));
        assertTrue(SqlValidator.checkIsSelect("-- comment\nSELECT * FROM table"));
    }
    ...
    public void testCheckIsNotSelect() {
        assertFalse(SqlValidator.checkIsSelect("INSERT INTO table VALUES (1)"));
        assertFalse(SqlValidator.checkIsSelect("UPDATE table SET col=1"));
        assertFalse(SqlValidator.checkIsSelect("DELETE FROM table"));
    }
}
